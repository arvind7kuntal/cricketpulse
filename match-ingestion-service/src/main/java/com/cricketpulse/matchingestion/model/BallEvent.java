package com.cricketpulse.matchingestion.model;
...
public class BallEvent {
    ...
    @NotBlank (message = "matchId can not be empty")
    ...
    @NotBlank (message = "batsman is required")
    private String batsmanName;
    @NotBlank(message="bowler is required")
